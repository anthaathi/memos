...
type Memo struct {
	...
	Folder        string `protobuf:"bytes,19,opt,name=folder,proto3" json:"folder,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"\blocation\x18\x12 \x01(\v2\x16.memos.api.v1.LocationB\x03\xe0A\x01H\x01R\blocation\x88\x01\x01\x123\n" +
	"\x06folder\x18\x13 \x01(\tB\x1b\xe0A\x01\xfaA\x15\n" +
	"\x13memos.api.v1/FolderR\x06folder\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +
